...
var third_party_assets = {
    css_js: [
        ...
        {
            name: "tui-dom",
            assets: ["./node_modules/tui-dom/dist/tui-dom.min.js"],
        },
        {
        ...
        {
            name: "chance",
            assets: ["./node_modules/chance/dist/chance.min.js"],
        },
        ...
        },
        {
            ...
            assets: [
                "./node_modules/bootstrap-filestyle2/src/bootstrap-filestyle.min.js",
            ],
        },
        {
            name: "echarts",
        ...
        {
            name: "jquery.easing",
            assets: ["./node_modules/jquery.easing/jquery.easing.min.js"],
        },
        {
        ...
        {
            name: "table-edits",
            assets: ["./node_modules/table-edits/build/table-edits.min.js"],
        },
        {
...
mix.copyDirectory(
    ...
    folder.dist_assets + "/libs/tinymce"
);
mix.copyDirectory(
...
mix.sass("resources/scss/app-dark.scss", folder.dist_assets + "css")
    .options({ processCssUrls: false })
    .minify(folder.dist_assets + "css/app-dark.css");
...
/* CHAT JS */
mix.js("resources/js/stream-chat.js", "public/js/chat.js");
