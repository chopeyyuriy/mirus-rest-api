            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="/contacts-list" class="waves-effect">
                        ...
                        <span key="t-contacts">@lang('translation.Users')</span>
                    </a>
                    <!-- <ul class="sub-menu" aria-expanded="false">
                ...
                <li>
                    <a href="/knowledge_base" class="waves-effect">
                        <i class="bx bx-store"></i>
                        <span key="t-orders">@lang('translation.Knowledge_base')</span>
                    </a>
                </li>
                <li>
                    <a href="/category" class="waves-effect">
                        <i class="bx bx-store"></i>
                        <span key="t-orders">@lang('translation.Categories')</span>
                    </a>
                </li>
                <li>
                    <a href="/report" class="waves-effect">
                        <i class="bx bx-store"></i>
                        <span key="t-orders">@lang('translation.Reports')</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('discountList')}}" class="waves-effect">
                        <i class="bx bx-store"></i>
                        <span key="t-coupons">@lang('translation.Coupons')</span>
                    </a>
                </li>
                <li>
                    <a href="/invoices-list" class="waves-effect">
                        <i class="bx bx-receipt"></i>
                        <span key="t-invoices">@lang('translation.Transactions')</span>
                    </a>
                    <!-- <ul class="sub-menu" aria-expanded="false">
                ...
                <li>
                    <a href="/terms-conditions" class="waves-effect">
                        <i class="bx bx-receipt"></i>
                        <span key="t-invoices">@lang('translation.Terms_and_Conditions')</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{route('chat')}}" class="waves-effect">
                        ...
                        <span key="t-chat">@lang('translation.Messages')</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="waves-effect has-arrow">
                        ...
                        <span key="t-file-manager">@lang('translation.Content_Management')</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('system_pages') }}" key="t-wallet">System Pages</a></li>
                        <li><a href="/apps-filemanager">Manage Slider</a></li>
                        <li><a href="{{ route('getfaq') }}">FAQs</a></li>
                        @isset($system_pages)
                            @foreach ($system_pages as $page)
                                <li><a href="@php
                                    if (Route::has($page->url)) {
                                        echo route($page->url);
                                    } else {
                                        echo $page->url;
                                    }
                                @endphp">{{ $page->title }}</a></li>
                            @endforeach
                        @endisset
                ...
                <li>
                    <a href="form-wizard" class="waves-effect">
                        <i class="bx bx-support"></i>
                        <span class="badge rounded-pill bg-danger float-end">10</span>
                        <span key="t-forms">@lang('translation.Support')</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{route('notification.index')}}" class="waves-effect">
                        ...
                        <span key="t-ui-elements">@lang('translation.Notifications')</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-crypto">@lang('translation.SystemSettings')</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="all-settings" key="t-wallet">All Settings</a></li>
                        <li><a href="crypto-wallet" key="t-wallet">@lang('translation.PaymentGatewayIntegration')</a>
                        </li>
                        <li><a href="crypto-buy-sell" key="t-buy">@lang('translation.EasyShipIntegration')</a></li>
                        <li><a href="crypto-exchange" key="t-exchange">@lang('translation.SendGridIntegration')</a></li>
                        <li><a href="crypto-lending" key="t-lending">@lang('translation.SupportSystemIntegration')</a>
                        </li>
                    </ul>
                </li>
