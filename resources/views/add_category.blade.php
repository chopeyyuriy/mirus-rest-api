                            ...
                            <div class="col-xl-2 col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <img class="rounded-circle category_image" src="{{ asset('/assets/images/users/no_image.png') }}" width="150px" height="150px" alt="Image">
                                        <input type="file" style="display: none" class="form-control @error('image') is-invalid @enderror" id="inputGroupFile02" name="image" accept="image/*" required autofocus>
