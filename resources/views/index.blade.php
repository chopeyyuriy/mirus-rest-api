...
@section('content')
    ...
    @endcomponent
    {{-- <livewire:home-slider view='show' /> --}}
    <div class="row">
        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <h5 class="font-size-15 text-truncate">
                                        <span class="ps-4">{{ $o->count() }}</span>
                                    </h5>
                                </div>
                                <div class="col-4">
                                    <p class="text-muted mb-0 text-truncate">Net Sale</p>
                                    <h5 class="font-size-15 text-truncate">
                                        {{ $o->where('payment_status', 'Paid')->sum('total') }}$</h5>
                                </div>
                                {{-- <div class="col-4">
                                    <p class="text-muted mb-0 text-truncate">Clients</p>
                                    <h5 class="font-size-15 text-truncate">18</h5>
                                </div> --}}
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="d-flex">
                                <a href="all-settings" class=" ms-auto btn btn-secondary">Settings</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="">
                <div class="">
                    <div class="row mx-0">
                        <div {{-- style="align-self: baseline" --}} class="col-sm-6 py-3 card">
                            <h3>Recent products</h3>
                            <div>
                                <div class="row mx-0">
                                    {{-- {{dd()}} --}}
                                    @foreach ($p->sortbydesc('created_at')->take(3) as $i)
                                        <div class="col-12 row px-0 mx-0 border-bottom mb-3 pb-2">
                                            <div class="col-6 px-0 pt-1">
                                                <h5>{{ $i->title }}</h5>
                                                <p class="text-muted mb-0 text-truncate">
                                                    {{ substr($i->long_disc, 0, 37) }}
                                                    ...</p>
                                            </div>
                                            <div class="col-6 row mx-0">
                                                @php
                                                    $rand = rand(10, 100);
                                                @endphp
                                                <div class="progress ms-auto col-6" data-value='{{ $rand }}'>
                        ...
                        <div class="col-sm-6 pb-3">
                            <div class="row col-12 px-0 mx-0">
                                <div class="col-5 ms-2  card py-3">
                                    <h4><i class="fas fa-sort-amount-up-alt"></i> Orders Total</h4>
                                    <h3>{{ $o->sum('total') }}$</h3>
                                </div>
                                <div class="col-5 card ms-3 py-3">
                                    <h4><i class="fas fa-balance-scale"></i> Net Sale</h4>
                                    <h3>{{ $o->where('payment_status', 'Paid')->sum('total') }}$</h3>
                                </div>
                            </div>
                            <div class="col-12 px-0 ">
                                <div class="p-3 card">
                                    <h3>Recent Users</h3>
                                    @foreach ($u->sortbydesc('created_at')->take(3) as $i)
                                        <div class="col-12 border-bottom pt-2">
                                            <h4 class="mb-0">{{ $i->name }} </h4>
                                            <p class="mb-1">User Type : <span class="h6">{{ $i->user_type }} </p>
                                            </span>
                                        </div>
                                    @endforeach
                                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                @foreach ($o->sortbydesc('created_at')->take(7) as $i)
                                    <tr>
                                        ...
                                        <td>{{$i->seller_name}}</td>
                                        <td>
                                            {{ gmdate('d/m/y', strtotime($i->created_at)) }}
                                        </td>
                                        <td>
                                            {{$i->total}}
                                        </td>
                                        <td>
                                            <span class="badge badge-pill {{$i->payment_status == 'Paid' ? 'badge-soft-success':'badge-soft-danger'}} font-size-11">{{$i->payment_status}}</span>
                                        </td>
                                    </tr>
                                @endforeach
