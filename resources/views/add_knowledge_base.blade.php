...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Add Knowledge Base @endslot
    @endcomponent

    <div class="row">
        <div class="col-12">
            <form method="POST" action="{{ route('knowledge_base.store') }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="type" class="select2 form-control select2-multiple" data-placeholder="Choose ...">
                                        <option value="knowledge_base" selected>Knowledge Base</option>
