        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        <div class="me-3">
                            <img src="{{ URL::asset('/assets/images/users/no_image.png') }}" alt=""
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="dropdown ms-auto">
                            <a class="text-muted dropdown-toggle font-size-16" role="button" data-bs-toggle="dropdown"
                                aria-haspopup="true">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item py-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="dropdown ms-2">
                                                <a class="text-muted dropdown-toggle font-size-14" href="#" role="button"
                                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="mdi mdi-dots-horizontal"></i>
                                                </a>
                        ...
                        <ul class="verti-timeline list-unstyled">
                            <li class="event-list active">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div>
                                            Posted <span class="font-weight-semibold">Beautiful Day with Friends</span>
                                            blog... <a href="#">View</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 100px;"><img src="{{ URL::asset('/assets/images/small/img-2.jpg') }}" alt=""
                                            class="avatar-md h-auto d-block rounded"></td>
                                    <td>
                                        <h5 class="font-size-13 text-truncate mb-1"><a href="#" class="text-dark">Beautiful
                                ...
                                <tr>
                                    <td><img src="{{ URL::asset('/assets/images/small/img-6.jpg') }}" alt=""
                                            class="avatar-md h-auto d-block rounded"></td>
                                    <td>
                                        <h5 class="font-size-13 text-truncate mb-1"><a href="#" class="text-dark">Drawing a
                                                sketch</a></h5>
                                        <p class="text-muted mb-0">02 Nov, 2020</p>
                                    </td>
                                ...
                                <tr>
                                    <td><img src="{{ URL::asset('/assets/images/small/img-1.jpg') }}" alt=""
                                            class="avatar-md h-auto d-block rounded"></td>
                                    <td>
                                        <h5 class="font-size-13 text-truncate mb-1"><a href="#" class="text-dark">Riding
                                                bike on road</a></h5>
                                        <p class="text-muted mb-0">24 Oct, 2020</p>
                                    </td>
                                ...
                                <tr>
                                    <td><img src="{{ URL::asset('/assets/images/small/img-2.jpg') }}" alt=""
                                            class="avatar-md h-auto d-block rounded"></td>
                                    <td>
                                        <h5 class="font-size-13 text-truncate mb-1"><a href="#" class="text-dark">Project
