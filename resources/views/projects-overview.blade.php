    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        <img src="{{ URL::asset('/assets/images/companies/img-1.png') }}" alt="" class="avatar-sm me-4">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap">
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{ URL::asset('/assets/images/users/no_image.png') }}"
                                            class="rounded-circle avatar-xs" alt=""></td>
                                    <td>
                                    ...
                                    <td>
                                        <div>
                                            <a href="#" class="badge bg-primary bg-soft text-primary font-size-11">UI /
                                                UX</a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td><img src="{{ URL::asset('/assets/images/users/avatar-4.jpg') }}"
                                            class="rounded-circle avatar-xs" alt=""></td>
                                    <td>
                        ...
                        <table class="table table-nowrap align-middle table-hover mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">Skote Landing.Zip</a>
                                        </h5>
